...
# Run test executable to get list of available unit_tests
...
# Catch --list-test-names-only reports the number of unit_tests, so 0 is... surprising
if(${result} EQUAL 0)
    #    message(WARNING
    #            "Test executable '${TECOMMON_EXECUTABLE}' contains no unit_tests!\n"
    #            )
...
# Create a list of all discovered unit_tests, which users may use to e.g. set
# properties on the unit_tests
